...
class info_for_vout_object : public abstract_object<info_for_vout_object>
{
   public:
      ...
      // sidechain::bitcoin_address address; // TODO: after 861 merge
      uint64_t                   amount;
...
// FC_REFLECT_DERIVED( graphene::chain::info_for_vout_object, (graphene::chain::object), (payer)(address)(amount)(used) ) // TODO: fix
FC_REFLECT_DERIVED( graphene::chain::info_for_vout_object, (graphene::chain::object), (payer)(amount)(used) )
